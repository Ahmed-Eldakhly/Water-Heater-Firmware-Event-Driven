...
# 1 "heater.c" 2
# 16 "heater.c"
# 1 "./general_bitConfig.h" 1
# 21 "./general_bitConfig.h"
...
# 21 "./general_bitConfig.h" 2
# 32 "./general_bitConfig.h"
...
static void Heater_turn_off(void)
{
    ...
    GPIO_WriteOnPin(2u , 2u , 0u);

    GPIO_WriteOnPin(2u , 5u , 0u);

    GPIO_WriteOnPin(1u , 7u , 0u);

    EEPROM_Save_Byte(0u , g_u8Heater_wanted_temperature);
...
void Heater_turn_on(void)
{
    ...
    uint8 u8Saved_temperature_in_EEPROM = EEPROM_Read_Byte(0u);
...
void Heater_display_on_temperature(void)
{
    ...
    if(g_u8Sync_flag == 0)
    {
        ...
        SevenSegment_SelectChip(SEVEN_SEGMENT_DISABLE_CHIP ,
                                ...
                                SEVEN_SEGMENT_DISABLE_CHIP);
        g_u8Sync_flag = 1;
        _delay((unsigned long)((5)*(8000000u/4000.0)));
    }
    else
    {
...
void Heater_change_temperature(void)
{
    ...
    if(Check_ON_Push_Button(1u , 1u) == PUSH_BUTTON_IS_PRESSED)
    {
        ...
        if(g_u8Heater_wanted_temperature > 35u)
        {
    ...
    else if(Check_ON_Push_Button(1u , 2u) == PUSH_BUTTON_IS_PRESSED)
    {
        ...
        if(g_u8Heater_wanted_temperature < 75u)
        {
    ...
    else if(Check_ON_Push_Button(1u , 0u) == PUSH_BUTTON_IS_PRESSED)
    {
...
void Heater_check_if_change_state_to_setup_or_off(void)
{
    ...
    if(Check_ON_Push_Button(1u , 1u) == PUSH_BUTTON_IS_PRESSED ||
       Check_ON_Push_Button(1u , 2u) == PUSH_BUTTON_IS_PRESSED)
    {
